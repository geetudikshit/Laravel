		...
		{{ Form::open(array('url' => 'doAskQuestion')) }}
			<table class="qa-form-tall-table">
				...
				@endif
					...
					<tr>
						<td class="qa-form-tall-data">
							{{ Form::text('title', Input::old('title'), array('placeholder' => 'Title','class'=>'qa-form-tall-text','name'=>'qa_title')) }}
					...
					<tr><td class="qa-form-tall-label"> Categories: </td></tr>
					<tr>
						<td class="qa-form-tall-data">
							{{ Form::text('categories', Input::old('categories'), array('list' => 'categories')) }}
